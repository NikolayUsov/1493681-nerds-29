...
Progect: nerds 
Добавляем информацию из дома  тестируем работу с git на mac os 10.11.6
---
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1493681-nerds-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
